...
```sh
  git clone https://github.com/Chaseknis/hello-rails_react.git
  cd hello-rails_react
...
Feel free to check the [issues page](https://github.com/Chaseknis/hello-rails_react/issues).
